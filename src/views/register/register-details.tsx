...
export const RegisterDetails: React.FC<Props> = ({ onSubmit }) => {
  ...
  const handleSelect = (field: any, value: any) =>
    setRegisterDetails((prevDate) => ({ ...prevDate, [field]: value }));
    ...
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <div className="w-full flex mt-5">
        <div className="flex flex-col m-1 w-2/6">
          ...
          <select
            ...
            required
            onChange={(e) =>
              handleSelect(USER_DETAILS?.dayOfBirth, parseInt(e.target.value))
            }
          >
        ...
        <div className="flex flex-col m-1 w-2/6">
          ...
          <select
            ...
            required
            onChange={(e) =>
              handleSelect(USER_DETAILS?.monthOfBirth, parseInt(e.target.value))
            }
          >
        ...
        <div className="flex flex-col m-1 w-3/6">
          ...
          <select
            ...
            required
            onChange={(e) =>
              handleSelect(USER_DETAILS?.yearOfBirth, parseInt(e.target.value))
            }
          >
      ...
      <div className="w-full flex flex-col mt-5">
        ...
        <select
          ...
          required
          onChange={(e) =>
            handleSelect(USER_DETAILS?.stateName, e.target.value)
          }
        >
          {states?.map((el) => (
      ...
      <div className="w-full flex flex-col mt-5">
        ...
        <select
          ...
          required
          onChange={(e) =>
            handleSelect(USER_DETAILS?.districtName, e.target.value)
          }
        >
          {districts?.map((el) => (
