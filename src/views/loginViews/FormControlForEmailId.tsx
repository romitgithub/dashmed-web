...
const FormControlForEmailID: React.FC<FormControlProps> = ({ setLoginChecks, loginChecks }) => {
     ...
     const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
          ...
          try {
               const response = await fetch(process.env.NEXT_PUBLIC_SERVER_URL + '/phr/api/login/sendOtp', {
                    ...
                    body: JSON.stringify({ value: emailId, type: 'EMAIL' }), // Send the necessary data in the body
               });
